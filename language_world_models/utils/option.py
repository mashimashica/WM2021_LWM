...
def parse_args():
    parser = argparse.ArgumentParser("Experiments in Language World Models")
    ...
    parser.add_argument("--beta_dim", type=int, default=128, help="beta dim")
    parser.add_argument("--m_dim", type=int, default=64, help="m dim")
    parser.add_argument("--z_dim", type=int, default=64, help="z dim")
    parser.add_argument("--pred_z_steps", type=int, default=10, help="number of z steps which LBF predict")
    parser.add_argument("--num_episodes", type=int, default=200000, help="number of episodes")
    parser.add_argument("--explore_episodes", type=int, default=10000, help="number of episodes to explore env")
    parser.add_argument("--explore_max_steps", type=int, default=300, help="")
